...
- `bench_sdpa_backends_gfx906.py`: reproduces SDPA backend availability checks (MATH vs FLASH_ATTENTION vs EFFICIENT_ATTENTION) on gfx906, including VRAM peaks and error states.
